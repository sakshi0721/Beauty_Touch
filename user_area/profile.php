...
<head>
    ...
    <style>
      ...
      /*hover style for side category bar*/
      .row .navbar-nav .nav-link:hover 
      {
          color: #ffffff;
      }
      .row .navbar-nav .nav-item
       {
          position: relative;
       }
      .row .navbar-nav .nav-item::after
       {
         position: absolute;
         bottom: 0;
         left: 0;
      ...
      .row .navbar-nav .nav-item:hover::after 
      {
        width: 100%;
      }
      .row .navbar-nav .nav-item::after 
...
<div class="container-fluid p-0 m-0">
 ...
 <!-- <div id="slidy-container">
   <figure id="slidy">
     <img src="photos/fslide.jpg" alt="Hello" data-caption="Beauty Touch" width="950" height="400">
     <img src="photos/mslide.jpg" alt="Hello" data-caption="Beauty Touch" width="950" height="400">
     <img src="photos/lslide.jpg" alt="Hello" data-caption="Beauty Touch" width="950" height="400">
   </figure>
 </div>
 <script>
 ...
 <!--fifth child-->
 <div class="row">
    <div class="col-md-2 p-0 border-end border-warning"  style="background-color:#e3b6c5">
        <ul class="navbar-nav text-center" style="height:100vh;">
           <li class="nav-item" style="background-color:#990033">
             <a class="nav-link text-light" href="#"><h4>Your Profile</h4></a>
           </li>

           <!-- fetching user image from user table -->
           <?php
           $name=$_SESSION['username'];
           $image="Select * from user_table where user_name='$name'";
